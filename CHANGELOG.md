...
- Empty-state welcome copy uses sentence case: "No changes to show, edited files will appear here as you save them." (was lowercase, which fit a tweet but not a UI string).
